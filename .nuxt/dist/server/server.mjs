...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/about.6ea259b9.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    component: () => import("./_nuxt/index.906230d9.js").then((m) => m.default || m)
  },
  {
    name: "iphone",
    path: "/iphone",
    ...
    component: () => import("./_nuxt/index.4ee9c6f6.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/iphone_name_.a5fdc1d5.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    component: () => import("./_nuxt/login.041f24d9.js").then((m) => m.default || m)
  },
  {
    name: "profile",
    path: "/profile",
    ...
    component: () => import("./_nuxt/profile.03c96631.js").then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth.fb87bdf9.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.806f5689.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default.173c77d4.js").then((m) => m.default || m)),
  sidebar: defineAsyncComponent(() => import("./_nuxt/sidebar.106e5da3.js").then((m) => m.default || m))
};
