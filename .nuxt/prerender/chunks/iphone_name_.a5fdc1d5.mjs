...
import { computed, resolveComponent, withCtx, unref, createTextVNode, toDisplayString, createVNode, useSSRContext } from 'file://C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr } from 'file://C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_Title, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Iphone${ssrInterpolate(unref(name))}`);
                } else {
                  return [
                    createTextVNode("Iphone" + toDisplayString(unref(name)), 1)
                  ];
                }
              }),
              _: 1
      ...
      _push(`<div class="flex justify-center w-full mt-20"><div class="grid grid-cols-2"><div><img${ssrRenderAttr("src", `/images/iphone${unref(route).params.name}.webp`)} alt=""></div><div class="text-center"><h1 class="text-3xl">Iphone${ssrInterpolate(unref(name))}</h1><button class="p-3 bg-indigo-900 text-white rounded-md mt-5 w-48">`);
      if (isInCart()) {
...
//# sourceMappingURL=iphone_name_.a5fdc1d5.mjs.map
