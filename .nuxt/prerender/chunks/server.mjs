import { getCurrentInstance, inject, computed, defineComponent, provide, h, Suspense, Transition, reactive, defineAsyncComponent, isRef, toRef, ref, resolveComponent, watchEffect, markRaw, shallowRef, useSSRContext, createApp, onErrorCaptured, unref, withCtx, createVNode } from 'file://C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/node_modules/ohmyfetch/dist/node.mjs';
import { joinURL, hasProtocol, isEqual, parseURL } from 'file://C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/node_modules/ufo/dist/index.mjs';
import { createHooks } from 'file://C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/node_modules/unctx/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter } from 'file://C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sendRedirect } from 'file://C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/node_modules/h3/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/node_modules/defu/dist/defu.mjs';
import { isFunction } from 'file://C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/node_modules/@vue/shared/index.js';
import { ssrRenderSuspense, ssrRenderComponent } from 'file://C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    file: "C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/pages/about.vue",
    children: [],
    meta: meta$5,
    alias: (meta$5 == null ? void 0 : meta$5.alias) || [],
    component: () => import('./about.6ea259b9.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    file: "C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/pages/index.vue",
    children: [],
    meta: meta$4,
    alias: [],
    component: () => import('./index.906230d9.mjs').then((m) => m.default || m)
  },
  {
    name: "iphone",
    path: "/iphone",
    file: "C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/pages/iphone/index.vue",
    children: [],
    meta: meta$3,
    alias: [],
    component: () => import('./index.4ee9c6f6.mjs').then((m) => m.default || m)
  },
  {
    name: "iphone-iphonename",
    path: "/iphone/iphone:name",
    file: "C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/pages/iphone/iphone[name].vue",
    children: [],
    meta: meta$2,
    alias: [],
    component: () => import('./iphone_name_.a5fdc1d5.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    file: "C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/pages/login.vue",
    children: [],
    meta: meta$1,
    alias: [],
    component: () => import('./login.041f24d9.mjs').then((m) => m.default || m)
  },
  {
    name: "profile",
    path: "/profile",
    file: "C:/Users/Nspira/documents/nuxt_3/nuxt3_iphoneApp/pages/profile.vue",
    children: [],
    meta,
    alias: (meta == null ? void 0 : meta.alias) || [],
    component: () => import('./profile.03c96631.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.806f5689.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: defineAsyncComponent(() => import('./default.173c77d4.mjs').then((m) => m.default || m)),
  sidebar: defineAsyncComponent(() => import('./sidebar.106e5da3.mjs').then((m) => m.default || m))
};
